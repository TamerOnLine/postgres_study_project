...
```bash
git clone https://github.com/TamerOnLine/tameronline-postgres_study_project.git
cd tameronline-postgres_study_project
```

- Make sure you have Git installed: [https://git-scm.com](https://git-scm.com)
<div align="center">
  <img src="screenshots/github_clone.png" alt="Cloning the repository via Git" width="600"/>
</div>
...
<div align="center">
  <img src="screenshots/main_menu.png" alt="Main CLI Menu" width="600"/>
</div>
